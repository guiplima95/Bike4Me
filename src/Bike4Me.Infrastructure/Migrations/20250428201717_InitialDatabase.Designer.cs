...
namespace Bike4Me.Infrastructure.Migrations
{
    ...
    [Migration("20250428201717_InitialDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bike4Me.Domain.Motorcycles.Motorcycle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("motorcycles", "bike4me");
                });

            modelBuilder.Entity("Bike4Me.Domain.Motorcycles.MotorcycleModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Manufacturer", "Bike4Me.Domain.Motorcycles.MotorcycleModel.Manufacturer#Manufacturer", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Name", "Bike4Me.Domain.Motorcycles.MotorcycleModel.Name#Name", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Year", "Bike4Me.Domain.Motorcycles.MotorcycleModel.Year#Year", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ToTable("motorcycle_models", "bike4me");
                });
            ...
            modelBuilder.Entity("Bike4Me.Domain.Motorcycles.Motorcycle", b =>
                {
                    b.OwnsOne("Bike4Me.Domain.Motorcycles.Plate", "Plate", b1 =>
                        {
                            ...
                            b1.ToTable("motorcycles", "bike4me");
